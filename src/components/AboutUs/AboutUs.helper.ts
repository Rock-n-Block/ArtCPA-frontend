export const aboutUsHelper = [
  ...
  { title: 'Mision', description: 'Our mission is to simplify for users and combine all the most powerful tools in one place. It can be said that Adora Multi Wallet is "All in one"', id: 2 },
